...
#' used to open CSV file. It contributes to the function \link{fars_read_years}.
#'
#'
...
#' This parameter generated by: \code{\link{fars_map_state}}
#'
#'
...
#' using given \code{year} and a string "accident_" ... ".csv.bz2".
#'
#' @details This function contributes to the functions \link{fars_read_years},
#' \link{fars_map_state}
#'
...
#'  year
#'
#' @note The returned string of this function used in the function \link{fars_read}}
#' and as an input in the function \link{fars_map_state} to make an input parameter
#' \code{filename}
#'
#' @examples
#' \dontrun{
#' make_filename(2015)}
#'
#' @seealso \link{fars_read}, \link{fars_map_state}
#'
#' @export
...
#' @importFrom magrittr "%>%"
#'
#' @return This function returns data frames or NULL if the year \code{year} is not valid
#'
...
#' data frames created by the function \link{fars_read_years}. It merges data frames,
...
#' location by year. The functions \link{make_filename} and \link{fars_read}
#' contribute to this function. If the \code{state.num} is invalid the function shows
#' an error message "invalid STATE number: ". If there are no accidents in the speicific
